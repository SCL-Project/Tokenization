...
contract VATToken_CH is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    address public CrossBorderContract;
    address initialOwner;
    address private RCTAddress;
    ReceiptTokenContract public RCTContract;
    VATToken_DE public VATToken_DE_Contract;
    ...
    /**
     * @dev Mapping to store the amount of TokenCredit for each company
     */
     ...
     *      This function is restricted to the government instances
    ...
    /**
     * @dev This function allows the owner of the VATToken_CH Contract to sell VAT_DE_Tokens if received. The VAT

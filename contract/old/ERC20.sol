...
contract ERC20 is Pausable, Ownable {
    struct InvestorData {
    ...
    function _mint(address to, uint256 amount) internal virtual onlyOwner whenNotPaused {
    ...
    function _burn(address from, uint256 amount) internal virtual onlyOwner whenNotPaused {
    ...
    function recover(address oldAddress, address newAddress) public onlyOwner whenNotPaused {
